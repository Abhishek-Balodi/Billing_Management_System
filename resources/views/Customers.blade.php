                ...
                <tbody>
                    @forelse ($customers as $customer)
                        <tr>
                            ...
                            <td>
                                <span class="badge table-badge {{ $customer->status ? 'bg-success' : 'bg-danger' }} fw-medium fs-10">
                                    {{ $customer->status_display }}
                                </span>
                            </td>
                            <td class="action-table-data">
                                <div class="edit-delete-action">
                                    <a class="me-2 p-2" href="{{ route('customers.show', $customer->id) }}">
                                        <i data-feather="eye" class="feather-eye"></i>
                                    </a>
                                    <a class="me-2 p-2" href="#" data-bs-toggle="modal" data-bs-target="#edit-customer-{{ $customer->id }}">
                                        <i data-feather="edit" class="feather-edit"></i>
                                    </a>
                                    <a class="p-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete-modal-{{ $customer->id }}">
            ...
            <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label">Shipping Address <span class="text-danger ms-1">*</span></label>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <div class="add-image-upload">
                                <div class="add-image p-1 border-solid">
                                    <img src="{{ $customer->image ? asset('storage/' . $customer->image) : asset('assets/img/supplier/supplier-01.png') }}" alt="image">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label class="form-label">Shipping Address <span class="text-danger ms-1">*</span></label>
                                    <input type="text" class="form-control" name="shipping_address" value="{{ old('shipping_address', $customer->shipping_address) }}">
                                    @error('shipping_address') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label class="form-label">Billing Address <span class="text-danger ms-1">*</span></label>
                                    <input type="text" class="form-control" name="billing_address" value="{{ old('billing_address', $customer->billing_address) }}">
                                    @error('billing_address') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="form-label">GSTIN</label>
                                    <input type="text" class="form-control" name="gstin" value="{{ old('gstin', $customer->gstin) }}">
                                    @error('gstin') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="form-label">PAN</label>
                                    <input type="text" class="form-control" name="pan" value="{{ old('pan', $customer->pan) }}">
                                    @error('pan') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            <div class="col-lg-12">
                            ...
                            <div class="col-md-12">
                                <div class="mb-0">
                                    <div class="status-toggle modal-status d-flex justify-content-between align-items-center">
                                        <span class="status-label">Status</span>
                                        <input type="checkbox" id="user-{{ $customer->id }}" class="check" name="status" value="1" {{ old('status', $customer->status) == 1 ? 'checked' : '' }}>
                                        <label for="user-{{ $customer->id }}" class="checktoggle"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                <div class="page-wrapper-new p-0">
                    <div class="content p-5 px-3 text-center">
                        ...
                        <p class="mb-0 fs-16">Are you sure you want to delete {{ $customer->first_name }} {{ $customer->last_name }}?</p>
...
<script>
    $(document).ready(function() {
        ...
        $('.dropdown-menu [data-sort]').on('click', function(e) {
            ...
            if (sortType === 'latest') {
                table.order([16, 'desc']).draw(); // Created On descending
            } else if (sortType === 'asc') {
                table.order([2, 'asc']).draw(); // Customer Name ascending
            } else if (sortType === 'desc') {
                table.order([2, 'desc']).draw(); // Customer Name descending
            }
        });
        ...
        $('.dropdown-menu [data-status]').on('click', function(e) {
            ...
            if (status !== '') {
                ...
                table.column(17).search(searchValue, true, false).draw();
            } else {
