...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/layout-horizontal.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Sep 2025 11:45:52 GMT -->
                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    <a href="javascript:void(0);"><span>Purchase</span><span
                                            class="menu-arrow"></span></a>
                                    <ul>
                                        <li><a href="{{ route('purchases.index') }}"><span>Purchases</span></a></li>
