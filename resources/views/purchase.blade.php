    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <a href="#" class="btn btn-primary mb-3"><i class="ti ti-plus me-1"></i>Add Vendor</a>
                ...
                <div class="mb-3">
                    <label class="form-label">Rev. Charge</label>
                    <select class="form-select">
            ...
            <div class="col-lg-8 col-md-12">
                <h5 class="fw-bold mb-3">Purchase Invoice Detail</h5>
        ...
        <div class="float-end mb-3">
            ...
            <div class="btn btn-primary d-inline"><i class="ti ti-currency-rupee"></i> Rs % <i class="ti ti-plus"></i></div>
        </div>
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td><input type="text" class="form-control bg-light" placeholder="Enter Product name"><br><input type="text" class="form-control" placeholder="Item Note..."></td>
            ...
            <div class="col-md-6">
                <div class="d-flex justify-content-end">
                    <table class="table table-borderless w-auto">
                        ...
                        <tr>
                            <td>Round Off</td>
                            <td><div class="form-check form-switch d-inline"><input class="form-check-input" type="checkbox" checked></div> 0</td>
                        </tr>
                        <tr class="bg-warning">
                            <td>Grand Total</td>
                            <td>0</td>
